"""
Django settings for eallot project.
...
SECRET_KEY = 'vwf6)abh@cj%ye349=t3gp@md0ckqr-a8rm7$gzx1(c!4rk@)c'
...
WSGI_APPLICATION = 'eallot.wsgi.application'
